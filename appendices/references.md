...
| 4 — AI Agent Security | Greshake, K., Abdelnabi, S., Mishra, S., Endres, C., Holz, T., Fritz, M., "Not What You've Signed Up For: Compromising Real-World LLM-Integrated Applications with Indirect Prompt Injection" | 2023 | `https://arxiv.org/abs/2302.12173` |
| 4 — AI Agent Security | OWASP Agentic Security Initiative, "Agentic AI — Threats and Mitigations" (v1.0) | 2025 | `https://genai.owasp.org/resource/agentic-ai-threats-and-mitigations/` |
...
| 7 — AI Model Security | Yeom, S., Giacomelli, I., Fredrikson, M., Jha, S., "Privacy Risk in Machine Learning: Analyzing the Connection to Overfitting" | 2017 | `https://arxiv.org/abs/1709.01604` |
